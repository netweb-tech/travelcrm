...
<body class="hold-transition light-skin sidebar-mini theme-rosegold onlyheader">
   ...
   <!--  <div class="wrapper"> --> <div class="container" style="margin:5% 10% 5% 10%">
                        ...
                        <div class="col-12">
                            ...
                            <div class="box">
                                ...
                                <div class="box-header with-border">
                                    ...
                                    <h4 class="box-title">Supplier Registration</h4>
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" class="form-control" placeholder="PASSWORD"
                                                        ...
                                                        name="acc_password" id="acc_password">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" class="form-control" placeholder="CONFIRM PASSWORD"
                                                        ...
                                                        name="acc_confirm_password" id="acc_confirm_password">
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label>Supplier Reference ID </label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control select2" name="supplier_country"
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="box-header with-border"
                                                    ...
                                                    <button type="button" id="create_supplier"
                                                        ...
                                                        class="btn btn-rounded btn-primary mr-10">Register</button>
        ...
        <script>
            ...
            $(document).on("click", "#create_supplier", function ()
...

                {
                    ...
                    var acc_confirm_password = $("#acc_confirm_password").val();
...

                    {
                        ...
                        $("#acc_password").css("border", "1px solid #cf3c63");
...

                    {
                        ...
                        $("#acc_password").css("border", "1px solid #9e9e9e");



                    }

                     if (acc_confirm_password.trim() == "")
...

                    {
                        ...
                        $("#acc_confirm_password").css("border", "1px solid #cf3c63");
...

                    {
                        ...
                        $("#acc_confirm_password").css("border", "1px solid #9e9e9e");
                    ...
                    if (acc_confirm_password.trim() != "" && acc_password.trim() != "" && (acc_confirm_password!=acc_password))
...

                    {
                        ...
                        $("#supplier_country").parent().find(".select2-selection").css("border", "1px solid #cf3c63");
...

                    {
                        ...
                        $("#supplier_country").parent().find(".select2-selection").css("border", "1px solid #9e9e9e");
                    ...
                    if (supplier_opr_currency == "") {
                        ...
                        $("#supplier_opr_currency").parent().find(".select2-selection").css("border", "1px solid #cf3c63");

                    } else {

                        $("#supplier_opr_currency").parent().find(".select2-selection").css("border", "1px solid #9e9e9e");

                    }

                    if (supplier_opr_countries == "") {

                        $("#supplier_opr_countries").parent().find(".select2-selection").css("border", "1px solid #cf3c63");

                    } else {

                        $("#supplier_opr_countries").parent().find(".select2-selection").css("border", "1px solid #9e9e9e");
                    ...
                    if (service_type == "") {
                        ...
                        $("#service_type").parent().find(".select2-selection").css("border", "1px solid #9e9e9e");
                    ...
                    } else if (acc_password.trim() == ""){

                        $("#acc_password").focus();

                    } else if(acc_confirm_password.trim() == ""){

                        $("#acc_confirm_password").focus();

                    }else if (acc_confirm_password.trim() != "" && acc_password.trim() != "" && (acc_confirm_password!=acc_password)) {
...

                            {
...

                                {
                                    ...
                                    swal("Already Exist!",
                                        ...
                                        "Supplier with this email or contact number already exists");
...

                                {
                                    ...
                                    swal({
                                            ...
                                            text: "Supplier Created Successfully ! You will be able to login once TravelDoor administrator approves your account.",
