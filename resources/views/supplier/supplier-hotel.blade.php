							...
							<div class="row">
								...
								<div class="col-sm-6 col-md-3">
									<div class="form-group">
										...
										<a href="{{route('supplier-create-hotel')}}"><button type="button"
											...
											<div class="table-responsive">
												...
												<tr id="tr_{{$hotels->hotel_id}}">
													...
													<td>
														...
														<a href="{{route('supplier-hotel-details',['hotel_id'=>$hotels->hotel_id])}}"><i class="fa fa-eye"></i></a>

														<a href="{{route('supplier-edit-hotel',['hotel_id'=>$hotels->hotel_id])}}"><i class="fa fa-pencil"></i></a>
