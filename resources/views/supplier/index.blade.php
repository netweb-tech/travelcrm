							...
							<form id="login_form" method="post">
								...
								<div class="form-group">
									...
									<div class="input-group mb-3">
										...
										<input id="login_username" type="text" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Email Address" name="username">
								...
								<div class="form-group">
								  ...
								  <div class="row">
								   ...
								   <div class="row">
									...
									<div class="col-12 text-center">
										<p class="bg-transparent text-white">Don't have supplier account yet? <br><a href="{{route('register-supplier')}}"  class="hover-info text-white">Click here</a></p>
									</div>
								</div>
...

	{
...

		{
			...
			$.ajax({
				...
				url:"{{route('supplier-login-check')}}",
...

				{
...

					{
						...
						window.location.href="{{route('supplier-home')}}";

					}
					else if(response.indexOf("inactive")!=-1)
