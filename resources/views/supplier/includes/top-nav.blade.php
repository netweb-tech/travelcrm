          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu animated flipInX">
              ...
              <li class="user-header bg-img" style="background-image: url('{{ asset('assets/images/color-plate/theme-oceansky.jpg')}}')" data-overlay="3">
				  ...
				  <div class="flexbox align-self-center">					  
					...
					<h4 class="user-name align-self-center">
						...
						<span>{{Session::get('travel_supplier_fullame')}}</span>

						<small>{{Session::get('travel_email_supplier')}}</small>
              ...
              <li class="user-body">
				    ...
				    <a class="dropdown-item" href="{{route('supplier-profile')}}"><i class="ion ion-person"></i> My Profile</a>
