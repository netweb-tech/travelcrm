                                            ...
                                            <div class="row mb-10">
                                                <div class="col-sm-4" style="display:none">
                                                    <button type="button" class="btn btn-rounded btn-primary mr-10 markup_details_btn" data-target="#markup_details1" data-toggle="collapse">
                                                        ...
                                                        <br>
                                                        <div id="markup_details1" class=" markup_details_divs collapse cstm-div">
                                                            <div class="col-sm-12 col-md-12 markup_div1" id="markup_div__1__1">
                                                                ...
                                                                <div  class="form-group add_more_markup_div">
                                                                    <img id="add_more_markup__1__1" class="plus-icon add_more_markup" style="display: block !important;margin-left: auto;" src="{{ asset('assets/images/add_icon.png') }}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <button type="button" class="btn btn-rounded btn-primary mr-10 surcharge_details_btn" data-target="#surcharge_details1" data-toggle="collapse">
                                                        ...
                                                        <div id="surcharge_details1" class="surcharge_details_div collapse cstm-div">
                                                           <div class="col-sm-12 col-md-12 surcharge_div1" id="surcharge_div__1__1">
                                                            ...
                                                            <div class="form-group">
                                                                <input type="text" class="form-control surcharge_price" placeholder="Price" id="surcharge_price__1__1" name="surcharge_price[0][]">
                                                            </div>
                                                            <div class="form-group add_more_surcharge_div">
                                                               <img id="add_more_surcharge__1__1" class=" add_more_surcharge plus-icon pull-right" style="display: block;" src="{{ asset('assets/images/add_icon.png') }}">
                                                           </div>
                                                       </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                                                        ...
                                                                                        <div class="col-md-2">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                    ...
                                                                                                    placeholder="Adult" id="room_adult__1__1" name="room_adult[0][]">
                                                                                            </div>
                                                                                        ...
                                                                                        <div class="col-md-2">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                    ...
                                                                                                    placeholder="CWB" id="room_cwb__1__1" name="room_cwb[0][]">
                                                                                            </div>
                                                                                        ...
                                                                                        <div class="col-md-2">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                    ...
                                                                                                    placeholder="CNB " id="room_cnb__1__1" name="room_cnb[0][]">
                                                                                            </div>
                                                ...
                                                <div class="col-sm-12 col-md-12 add_more_main_rates_allocations_div">
                                                    <img  id="add_more_main_rates_allocations1" class="add_more_main_rates_allocations plus-icon" style="display: block;" src="{{ asset('assets/images/add_icon.png') }}">
                                                </div>
                                            </div>
                                        </div>
                                      ...
                                      <div id="add_on_details" class="collapse">
                                        ...
                                        <div class="row mt-15 mb-10">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="COST FOR ADULT " id="hotel_adult_cost1" name="hotel_adult_cost[]">
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="COST FOR CHILD"  id="hotel_child_cost1" name="hotel_child_cost[]">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-15 mb-10">
                                        ...
                                        <div class="col-sm-12 col-md-12 add_more_addon_div">
                                                    <img id="add_more_addon1" class="add_more_addon plus-icon" style="display: block;" src="{{ asset('assets/images/add_icon.png') }}">
                                                </div>
                                            </div>
                                    </div>
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <button type="button" class="btn btn-rounded btn-primary mr-10"    data-toggle="collapse" data-target="#policies">Add
                                        ...
                                        <div class="col-sm-12 col-md-12 add_more_policies_div">
                                                    <img id="add_more_policies1" class="add_more_policies plus-icon" style="display: block;" src="{{ asset('assets/images/add_icon.png') }}">
                                                </div>
                                            </div>
                                    </div>
 ...
 $(document).on("click",".add_more_main_rates_allocations",function()
    {
        ...
        clone_rates_allocations.find('#activity_markup__'+new_id+'__1').attr('name',"activity_markup["+old_id+"][]");
        clone_rates_allocations.find('#activity_amount__'+old_id+'__1').attr('id',"activity_amount__"+new_id+"__1");
        clone_rates_allocations.find('#activity_amount__'+new_id+'__1').attr('name',"activity_amount["+old_id+"][]");
         clone_rates_allocations.find(".add_more_markup_div").html('');
        clone_rates_allocations.find(".add_more_markup_div").append('<img id="add_more_markup__'+new_id+'__1" class="add_more_markup plus-icon" style="display: block;" src="'+add_url+'"> ');
        ...
        clone_rates_allocations.find('#surcharge_name__'+new_id+'__1').attr('name',"surcharge_name["+old_id+"][]");
        ...
        clone_rates_allocations.find('#surcharge_day__'+new_id+'__1').attr('name',"surcharge_day["+old_id+"][]");
        clone_rates_allocations.find('#surcharge_price__'+old_id+'__1').attr('id',"surcharge_price__"+new_id+"__1");
        clone_rates_allocations.find('#surcharge_price__'+new_id+'__1').attr('name',"surcharge_price["+old_id+"][]");
          clone_rates_allocations.find(".add_more_surcharge_div").html('');
        clone_rates_allocations.find(".add_more_surcharge_div").append('<img id="add_more_surcharge__'+new_id+'__1" class="add_more_surcharge plus-icon" style="display: block;" src="'+add_url+'"> ');
        ...
        clone_rates_allocations.find(".add_more_rooms_allocations_div").append('<img id="add_more_rooms_allocations__'+new_id+'__1" class="add_more_rooms_allocations plus-icon" style="display: block;" src="'+add_url+'"> ');

         $("#rates_allocations_div"+old_id).find(".add_more_main_rates_allocations_div").html("");
          if(old_id>1)
          {
           $("#rates_allocations_div"+old_id).find(".add_more_main_rates_allocations_div").append('<img id="remove_more_main_rates_allocations'+old_id+'" class="remove_more_main_rates_allocations minus-icon" style="display: block;" src="'+minus_url+'">');
            }
        clone_rates_allocations.find(".add_more_main_rates_allocations_div").html('');
        clone_rates_allocations.find(".add_more_main_rates_allocations_div").append(' <img id="remove_more_main_rates_allocations'+new_id+'" class="remove_more_main_rates_allocations minus-icon" style="display: block;" src="'+minus_url+'"> <img id="add_more_main_rates_allocations'+new_id+'" class="add_more_main_rates_allocations plus-icon" style="display: block;" src="'+add_url+'"> ');
    ...
    $(document).on("click", ".remove_more_main_rates_allocations", function () {
        ...
        {
           $("#rates_allocations_div"+old_id).find(".add_more_main_rates_allocations_div").html("");
        $("#rates_allocations_div"+old_id).find(".add_more_main_rates_allocations_div").append('<img id="remove_more_main_rates_allocations'+old_id+'" class="remove_more_main_rates_allocations minus-icon" style="display: block;" src="'+minus_url+'"> <img id="add_more_main_rates_allocations'+old_id+'" class="add_more_main_rates_allocations plus-icon" style="display: block;" src="'+add_url+'">'); 
        }
        else
        {

        $("#rates_allocations_div"+old_id).find(".add_more_main_rates_allocations_div").html("");
        $("#rates_allocations_div"+old_id).find(".add_more_main_rates_allocations_div").append(' <img id="add_more_main_rates_allocations'+old_id+'" class="add_more_main_rates_allocations plus-icon" style="display: block;" src="'+add_url+'">'); 
        }
    ...
    $(document).on("click",".add_more_policies",function()
    {
        ...
        clone_policies.find("label#policy_desc_label"+old_id).attr({"id":"policy_desc_label" + new_id,"for":"policy_desc" + new_id}).val("");
          ...
          if(old_id>1)
          {
           $("#other_policies_div"+old_id).find(".add_more_policies_div").append('<img id="remove_more_policies'+old_id+'" class="remove_more_policies minus-icon" style="display: block;" src="'+minus_url+'">');
            }
        clone_policies.find(".add_more_policies_div").html('');
        clone_policies.find(".add_more_policies_div").append(' <img id="remove_more_policies'+new_id+'" class="remove_more_policies minus-icon" style="display: block;" src="'+minus_url+'"> <img id="add_more_policies'+new_id+'" class="add_more_policies plus-icon" style="display: block;" src="'+add_url+'"> ');
      ...
      $(document).on("click", ".remove_more_policies", function () {
        ...
        {
           $("#other_policies_div"+old_id).find(".add_more_policies_div").html("");
        $("#other_policies_div"+old_id).find(".add_more_policies_div").append('<img id="remove_more_policies'+old_id+'" class="remove_more_policies minus-icon" style="display: block;" src="'+minus_url+'"> <img id="add_more_policies'+old_id+'" class="add_more_policies plus-icon" style="display: block;" src="'+add_url+'">'); 
        }
        else
        {

           $("#other_policies_div"+old_id).find(".add_more_policies_div").html("");
        $("#other_policies_div"+old_id).find(".add_more_policies_div").append(' <img id="add_more_policies'+old_id+'" class="add_more_policies plus-icon" style="display: block;" src="'+add_url+'">'); 
        }
    });
    ...
    $(document).on("click",".add_more_addon",function()
    {
        ...
        if(old_id>1)
        {
           $("#addon_div"+old_id).find(".add_more_addon_div").append('<img id="remove_more_addon'+old_id+'" class="remove_more_addon minus-icon" style="display: block;" src="'+minus_url+'">');
       }
       clone_addon.find(".add_more_addon_div").html('');
       clone_addon.find(".add_more_addon_div").append(' <img id="remove_more_addon'+new_id+'" class="remove_more_addon minus-icon" style="display: block;" src="'+minus_url+'"> <img id="add_more_addon'+new_id+'" class="add_more_addon plus-icon" style="display: block;" src="'+add_url+'"> ');
     ...
     $(document).on("click", ".remove_more_addon", function () {
        ...
        {
           $("#addon_div"+old_id).find(".add_more_addon_div").html("");
        $("#addon_div"+old_id).find(".add_more_addon_div").append('<img id="remove_more_addon'+old_id+'" class="remove_more_addon minus-icon" style="display: block;" src="'+minus_url+'"> <img id="add_more_addon'+old_id+'" class="add_more_addon plus-icon" style="display: block;" src="'+add_url+'">'); 
        }
        else
        {

        $("#addon_div"+old_id).find(".add_more_addon_div").html("");
        $("#addon_div"+old_id).find(".add_more_addon_div").append(' <img id="add_more_addon'+old_id+'" class="add_more_addon plus-icon" style="display: block;" src="'+add_url+'">'); 
        }
       ...
       $(document).on("click",".add_more_markup",function()
    {
        ...
        if(old_id>1)
        {
           $("#markup_div__"+parent_id[1]+"__"+old_id).find(".add_more_markup_div").append('<img id="remove_more_markup__'+parent_id[1]+'__'+old_id+'" class="remove_more_markup minus-icon" style="display: block;" src="'+minus_url+'">');
       }
       clone_markup.find(".add_more_markup_div").html('');
       clone_markup.find(".add_more_markup_div").append(' <img id="remove_more_markup__'+parent_id[1]+'__'+new_id+'" class="remove_more_markup minus-icon" style="display: block;" src="'+minus_url+'"> <img id="add_more_markup__'+parent_id[1]+'__'+new_id+'" class="add_more_markup plus-icon" style="display: block;" src="'+add_url+'"> ');
       ...
       $(document).on("click", ".remove_more_markup", function () {
         ...
         {
           $("#markup_div__"+parent_id[1]+"__"+old_id).find(".add_more_markup_div").html("");
           $("#markup_div__"+parent_id[1]+"__"+old_id).find(".add_more_markup_div").append('<img id="remove_more_markup__'+parent_id[1]+'__'+old_id+'" class="remove_more_markup minus-icon" style="display: block;" src="'+minus_url+'"> <img id="add_more_markup__'+parent_id[1]+'__'+old_id+'" class="add_more_markup plus-icon" style="display: block;" src="'+add_url+'"> '); 
       }
       else
       {

         $("#markup_div__"+parent_id[1]+"__"+old_id).find(".add_more_markup_div").html("");
         $("#markup_div__"+parent_id[1]+"__"+old_id).find(".add_more_markup_div").append(' <img id="add_more_markup__'+parent_id[1]+'__'+old_id+'" class="add_more_markup plus-icon" style="display: block;" src="'+add_url+'"> '); 
     }
          ...
          $(document).on("click",".add_more_surcharge",function()
    {
        ...
        if(old_id>1)
        {
           $("#surcharge_div__"+parent_id[1]+"__"+old_id).find(".add_more_surcharge_div").append('<img id="remove_more_surcharge__'+parent_id[1]+'__'+old_id+'" class="remove_more_surcharge minus-icon" style="display: block;" src="'+minus_url+'">');
       }
       clone_markup.find(".add_more_surcharge_div").html('');
       clone_markup.find(".add_more_surcharge_div").append(' <img id="remove_more_surcharge__'+parent_id[1]+'__'+new_id+'" class="remove_more_surcharge minus-icon" style="display: block;" src="'+minus_url+'"> <img id="add_more_surcharge__'+parent_id[1]+'__'+new_id+'" class="add_more_surcharge plus-icon" style="display: block;" src="'+add_url+'"> ');
        ...
        $(".surcharge_div"+parent_id[1]+":last").after(clone_markup);
         ...
         {
           $("#surcharge_div__"+parent_id[1]+"__"+old_id).find(".add_more_surcharge_div").html("");
           $("#surcharge_div__"+parent_id[1]+"__"+old_id).find(".add_more_surcharge_div").append('<img id="remove_more_surcharge__'+parent_id[1]+'__'+old_id+'" class="remove_more_surcharge minus-icon" style="display: block;" src="'+minus_url+'"> <img id="add_more_surcharge__'+parent_id[1]+'__'+old_id+'" class="add_more_surcharge plus-icon" style="display: block;" src="'+add_url+'"> '); 
       }
       else
       {

         $("#surcharge_div__"+parent_id[1]+"__"+old_id).find(".add_more_surcharge_div").html("");
         $("#surcharge_div__"+parent_id[1]+"__"+old_id).find(".add_more_surcharge_div").append(' <img id="add_more_surcharge__'+parent_id[1]+'__'+old_id+'" class="add_more_surcharge plus-icon" style="display: block;" src="'+add_url+'"> '); 
     }
           ...
           $(document).on("click",".add_more_rooms_allocations",function()
    {
       ...
       //  clone_markup.find('#activity_amount__'+parent_id[1]+'__'+old_id).attr('id',"activity_amount__"+parent_id[1]+"__"+new_id);
        ...
        if(old_id>1)
        {
           $("#room_details__"+parent_id[1]+"__"+old_id).find(".add_more_rooms_allocations_div").append('<img id="remove_more_rooms_allocations__'+parent_id[1]+'__'+old_id+'" class="remove_more_rooms_allocations minus-icon" style="display: block;" src="'+minus_url+'">');
       }
       clone_rooms.find(".add_more_rooms_allocations_div").html('');
       clone_rooms.find(".add_more_rooms_allocations_div").append(' <img id="remove_more_rooms_allocations__'+parent_id[1]+'__'+new_id+'" class="remove_more_rooms_allocations minus-icon" style="display: block;" src="'+minus_url+'"> <img id="add_more_rooms_allocations__'+parent_id[1]+'__'+new_id+'" class="add_more_rooms_allocations plus-icon" style="display: block;" src="'+add_url+'"> ');
