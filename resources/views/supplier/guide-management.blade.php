	...
	<div class="content-header">
		...
		<div class="d-flex align-items-center">
			...
			<div class="mr-auto">
				...
				<h3 class="page-title">Guide Management</h3>
 ...
 -->
						...
						<div class="col-sm-6 col-md-2">
							...
							<div class="form-group">
								...
								<a href="{{route('supplier-create-guide')}}"><button type="button"
											...
											<tbody>
												...
												<tr id="tr_{{$guide->guide_id}}">
													...
													<td>
														...
														<a href="{{route('supplier-guide-details',['guide_id'=>$guide->guide_id])}}"><i class="fa fa-eye"></i></a>

														<a href="{{route('supplier-edit-guide',['guide_id'=>$guide->guide_id])}}"><i class="fa fa-pencil"></i></a>
