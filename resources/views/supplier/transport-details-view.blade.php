									...
									<div class="row mb-10" style="display: none">
										...
										<div id="transport_pricing_details" class="row">
											...
											<div class="col-md-6">
												...
												<div class="col-md-6">
												<p class="" id="transfer_vehicle_type{{$transport_count}}">
                                        ...
                                        @endforeach
											...
											<div class="col-md-12">
												<div class="row">
													@php
													$get_transfer_images=unserialize($transfer_transport_tariff[$transport_count]['transfer_images']);
										...
										<div class="row mb-10">
											<div class="col-md-12">
												...
												<a href="{{route('supplier-edit-transport',['transport_id'=>$get_transport->transport_id])}}" id="update_transfer" class="btn btn-rounded btn-primary mr-10">EDIT</a>
											</div>
										</div>
									</div>
