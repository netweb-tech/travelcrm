												...
												<div id="season_showdetails{{($rate_allocation_count+1)}}" class="rate_allocation_details_data row">
													<div class="row">
														<div class="col-md-12">
															...
															<div class="row mb-10" style="padding: 0 20px;display: none">
									...
									<div class="col-md-12">
										...
										<div class="row mb-10">
											<div class="col-md-12">
												...
												<a href="{{route('supplier-edit-hotel',['hotel_id'=>$get_hotels->hotel_id])}}" id="update_hotel" class="btn btn-rounded btn-primary mr-10">EDIT</a>
											</div>
										</div>
									</div>
