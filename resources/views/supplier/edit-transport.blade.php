                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="supplier_name" name="supplier_name" value="{{$get_transport->supplier_id}}">
                     ...
                     <div class="row mb-10">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-6 transport_div" id="transport_div{{($transport+1)}}">
                            ...
                            <div id="previewImg_new{{($transport+1)}}" class="row previewImg_new">
                                @php
                                $get_transfer_images=unserialize($transfer_transport[$transport]['transfer_images']);
