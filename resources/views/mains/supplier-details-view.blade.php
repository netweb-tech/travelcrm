								...
								<div class="d-inline-block align-items-center">
									...
									<nav>
										...
										<ol class="breadcrumb">
											...
											<li class="breadcrumb-item active" aria-current="page">View Supplier Details
									...
									<div class="box-body">
										...
										<div class="row">
											...
											<div class="col-md-9">
												...
												<p class="" id="supplier_country"> @if($get_supplier->supplier_country!="" && $get_supplier->supplier_country!=null)

													@foreach($countries as $country)
													@if($country->country_id==$get_supplier->supplier_country)
