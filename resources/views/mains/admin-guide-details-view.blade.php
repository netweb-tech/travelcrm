											...
											<div class="col-md-8">
												...
												<div class="row">
													...
													<div class="col-md-9">
														...
														<p class="" id="supplier_id"> @if($get_guides->guide_supplier_id!="" && $get_guides->guide_supplier_id!=null)
												...
												<div class="row">
													...
													<div class="col-md-9">
														...
														<p class="" id="supplier_id"> @if($get_guides->guide_description!="" && $get_guides->guide_description!=null)
                                           ...
                                           @endphp
												...
												<div class="row mb-10">
													<div class="col-md-12">
														...
														<a href="{{route('admin-edit-guide',['guide_id'=>$get_guides->guide_id])}}" id="update_transfer" class="btn btn-rounded btn-primary mr-10">EDIT</a>
													</div>
												</div>
											</div>
