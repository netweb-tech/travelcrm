                            ...
                            <div class="form-group">
                                ...
                                <div class="intl-tel-input">
                                    ...
                                    <input id="customer_contact" type="text"
                                        ...
                                        placeholder="Mobile Number" maxlength="15" onkeypress='validateNumber(event)'>
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-sm-6 col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="address" rows="1" cols="5" class="form-control" placeholder="ADDRESS" name="address"></textarea>
                        ...
                        <div class="col-sm-6 col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <input id="area" type="text" class="form-control" placeholder="AREA" name="area">
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-sm-6 col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <p id="no_of_days_p">Number Of Days: 0</p>
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-sm-6 col-md-1">
                            ...
                            <div class="form-group">
                                ...
                                <input id="no_of_kids" type="text" class="form-control" value="" name="no_of_kids" onkeypress='validateNumber(event)' maxlength="3">
                        ...
                        <div class="col-sm-6 col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input id="customer_dob" type="text" class="form-control pull-right datepicker" placeholder="DATE" name="customer_dob">
                        ...
                        <div class="col-sm-6 col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input id="wedding_date" type="text" class="form-control pull-right datepicker" placeholder="DATE" name="wedding_date">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input id="passenger_dob" type="text" class="form-control pull-right datepicker"
                                        ...
                                        placeholder="BIRTHDATE" name="passenger_dob">
