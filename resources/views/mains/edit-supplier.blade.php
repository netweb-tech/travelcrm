                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Edit Supplier
                                </li>
                            </ol>
                        </nav>
                    </div>
            ...
            <div class="col-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row mb-10">
                            <div class="col-sm-12 col-md-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="SUPPLIER NAME " name="supplier_name"  id="supplier_name" value="{{$get_supplier['supplier_name']}}">
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-12 col-lg-6">
                        ...
                        <div class="row mb-10">
                            <div class="col-sm-12 col-md-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="COMPANY NAME " name="company_name" id="company_name" value="{{$get_supplier['company_name']}}">
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-12 col-lg-6">
                        ...
                        <div class="row mb-10">
                            <div class="col-sm-12 col-md-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="EMAIL ID" name="email_id" id="email_id" value="{{$get_supplier['company_email']}}">
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-12 col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="intl-tel-input">
                                        <input type="text" 
                                            ...
                                            placeholder="Enter Mobile Number" value="{{$get_supplier['company_contact']}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-12 col-lg-6">
                        ...
                        <div class="row mb-10">
                            <div class="col-sm-12 col-md-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="FAX NUMBER" name="fax_number" id="fax_number" value="{{$get_supplier['company_fax']}}">
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-12 col-lg-6">
                        ...
                        <div class="row mb-10">
                            <div class="col-sm-12 col-md-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Supplier Reference ID" name="supplier_reference_id" id="supplier_reference_id" value="{{$get_supplier['supplier_ref_id']}}">
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-12 col-lg-6">
                        ...
                        <div class="row mb-10">
                            <div class="col-sm-12 col-md-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" cols="5" class="form-control" placeholder="ADDRESS" name="address" id="address">{{$get_supplier['address']}}</textarea>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-12 col-lg-6">
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="supplier_country" id="supplier_country">
                                              <option hidden value="0">SELECT COUNTRY</option>

                                              @foreach($countries as $country)
                                                @if($get_supplier['supplier_country']==$country->country_id)
                         ...
                         <div class="row mb-10" id="city_div">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="CITY" name="supplier_city" id="supplier_city" value="{{$get_supplier['supplier_city']}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mb-10">
                            <div class="col-sm-12 col-md-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="CORPORATE REG NO" name="corporate_reg_no" id="corporate_reg_no" value="{{$get_supplier['corporate_reg_no']}}">
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-12 col-lg-6">
                        ...
                        <div class="row mb-10">
                            <div class="col-sm-12 col-md-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" cols="5" class="form-control" placeholder="CORPORATE DESCRIPTION " name="corporate_description" id="corporate_description">{{$get_supplier['corporate_desc']}}</textarea>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-12 col-lg-6">
                        ...
                        <div class="row mb-10">
                            <div class="col-sm-12 col-md-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="SKYPE ID" name="skype_id" id="skype_id" value="{{$get_supplier['skype_id']}}">
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-12 col-lg-6">
                                    ...
                                    <div class="bootstrap-timepicker">
                                        <div class="form-group">
                                            <div class="input-group">
                                                <input type="text" class="form-control timepicker" name="operating_hrs_from" id="operating_hrs_from" value="{{$get_supplier['operating_hrs_from']}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="bootstrap-timepicker">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control timepicker" name="operating_hrs_to" id="operating_hrs_to" value="{{$get_supplier['operating_hrs_to']}}">
                                ...
                                <div class="img_group">
                                    ...
                                    <div class="box1">
                                      <input class="hide" type="file" id="upload_certificate"
                                           ...
                                           name="supplier_certificate_file" onchange="previewFile('certificate')">
                                    ...
                                    <!-- ngRepeat: (itemindex,item) in temp_loop.enquiry_comment_attachment track by $index -->
                                     ...
                                     <img id="certificate_preview" height="200" alt="CERTIFICATE Preview..." src="{{ asset('assets/uploads/supplier_certificates/')}}/{{$get_supplier['certificate_corp']}}">
                                </div>
                        ...
                        <div class="row mb-10">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-6">
                                <div class="img_group">
                                    ...
                                    <!-- ngRepeat: (itemindex,item) in temp_loop.enquiry_comment_attachment track by $index -->
                                    <img id="logo_preview" height="200" alt="LOGO Preview..." src="{{ asset('assets/uploads/supplier_logos/')}}/{{$get_supplier['supplier_logo']}}">
                                </div>
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        " style="width: 100%;"
                                            tabindex="-1" aria-hidden="true" id="supplier_opr_currency" name="supplier_opr_currency[]" multiple="multiple" >
                                            @php
                                        $operating_currencies=explode(',',$get_supplier['supplier_opr_currency']);
                                            @endphp
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 " style="width: 100%;"
                                            tabindex="-1" aria-hidden="true" id="supplier_opr_countries" name="supplier_opr_countries[]" multiple="multiple">
                                             @php
                                        $operating_countries=explode(',',$get_supplier['supplier_opr_countries']);
                                            @endphp
                                              @foreach($countries as $country)
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-6">
                                <div class="form-group">
                                    <label style="display:block">BLACKOUT DAYS :<!-- <span class="asterisk">*</span> --></label>
                                            <input type="text" class="form-control blackout_datepicker" id="blackout_days" name="blackout_days" readonly="readonly" value="{{$get_supplier['blackout_dates']}}">
                        ...
                        <div class="row mb-10">
                              @php
                                $supplier_bank_details=unserialize($get_supplier['supplier_bank_details']);

                                    for($bank_count=0;$bank_count< count($supplier_bank_details);$bank_count++)
                                    {
                            @endphp
                            <div class="col-md-6 bank_div" id="bank_div_{{($bank_count+1)}}">
                               <div class="col-sm-12 ">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="ACCOUNT NUMBER" id="account_number_{{($bank_count+1)}}" name="account_number[]" value="{{$supplier_bank_details[$bank_count]['account_number']}}">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="BANK NAME" id="bank_name_{{($bank_count+1)}}" name="bank_name[]"value="{{$supplier_bank_details[$bank_count]['bank_name']}}">
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group">
                                    <label>BANK SWIFT CODE <span class="asterisk">*</span></label>
                                    <input type="text" class="form-control" placeholder="BANK SWIFT CODE"  id="bank_swift_{{($bank_count+1)}}" name="bank_swift[]" value="{{$supplier_bank_details[$bank_count]['bank_ifsc']}}">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="BANK IBAN CODE" id="bank_iban_{{($bank_count+1)}}" name="bank_iban[]" value="{{$supplier_bank_details[$bank_count]['bank_iban']}}">
                                </div>
                            </div>
                                <div class="col-sm-12 col-md-12">
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" style="width: 100%;"
                                           ...
                                           @foreach($currency as $curr)
                                            @if($supplier_bank_details[$bank_count]['bank_currency']==$curr->code)
                                            <option value="{{$curr->code}}" selected="selected">{{$curr->code}} ({{$curr->name}})</option>
                                            @else
                                              <option value="{{$curr->code}}">{{$curr->code}} ({{$curr->name}})</option>
                                            @endif
                        ...
                        <div class="row mb-10">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-6">
                                <div class="form-group">
                                    <div class="form-group">
                                            @php
                                        $service_type=explode(',',$get_supplier['supplier_service_type']);
                                            @endphp
                        ...
                        <div class="row mb-10">
                            ...
                            @php
                                $contact_persons=unserialize($get_supplier['contact_persons']);
                        ...
                        <div class="row mb-10">
                            <div class="col-md-12">
                                <div class="box-header with-border"
                                    ...
                                    <input type="hidden" name="supplier_id" value="<?php echo urlencode(base64_encode(base64_encode($get_supplier['supplier_id'])));?>">
                                    <button type="button" id="update_supplier" class="btn btn-rounded btn-primary mr-10">Update</button>
                                    <button type="button" id="discard_supplier" class="btn btn-rounded btn-primary">Discard</button>
                                </div>
                            </div>
                        </div>
                                <form>
    ...
    if (file) {
        ...
        $('.select2').select2();
         $('#supplier_opr_currency').select2({
          ...
          var selectedDates ="{{$get_supplier['blackout_dates']}}";
                    ...
                    $.ajax({
...

                        {
...

                           {
                              ...
                              swal("Already Exist!", "Supplier with this email or username already exists");
...

                          {
                            ...
                            swal({title:"Success",text:"Supplier Updated Successfully !",type: "success"},
...

                          {
                           ...
                           swal("ERROR", "Supplier cannot be updated right now! ");

                          }

                            $("#update_supplier").prop("disabled",false);
