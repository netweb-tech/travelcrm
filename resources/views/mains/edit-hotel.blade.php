                         ...
                         <div class="col-sm-6 col-md-6">
                            <div class="form-group">
                                ...
                                <textarea id="hotel_description" name="hotel_description" class="form-control" placeholder="HOTEL DESCRIPTION"
                                    spellcheck="false">{{$get_hotels->hotel_description}}</textarea>
                            </div>
                        </div>
                                            ...
                                            <div class="row mb-10">
                                                <div class="col-sm-4">
                                                    <button type="button" class="btn btn-rounded btn-primary mr-10 markup_details_btn" data-target="#markup_details1" data-toggle="collapse">
                                                        ...
                                                        <br>
                                                        <div id="markup_details1" class=" markup_details_divs collapse cstm-div show" style="display:none">
                                                            @php
                                                    ...
                                                    @if($markup_count==count($hotel_markup_details[$rate_allocation_count]['activity_nationality'])-1)
                                                     <img id="remove_more_markup__{{($rate_allocation_count+1)}}__{{($markup_count+1)}}" class="remove_more_markup minus-icon"   style="margin-left: auto;" src="{{ asset('assets/images/minus_icon.png') }}">
        ...
        for($surcharge_count=0;$surcharge_count< count($hotel_surcharge_details[$rate_allocation_count]['surcharge_name']);$surcharge_count++)
                            {
                                                           ...
                                                           <div class="col-sm-12 col-md-12 surcharge_div{{($rate_allocation_count+1)}}" id="surcharge_div__{{($rate_allocation_count+1)}}__{{($surcharge_count+1)}}">
                                                            ...
                                                            <div class="form-group">
                                                                <input type="text" class="form-control surcharge_price" placeholder="Price" id="surcharge_price__{{($rate_allocation_count+1)}}__{{($surcharge_count+1)}}" name="surcharge_price[{{$rate_allocation_count}}][]" value="{{$hotel_surcharge_details[$rate_allocation_count]['surcharge_price'][$surcharge_count]}}" onkeypress="javascript:return validateNumber(event)">
                                                            </div>
                                                            <div class="form-group add_more_surcharge_div">
                                                               <!-- <img id="add_more_surcharge__{{($rate_allocation_count+1)}}__{{($surcharge_count+1)}}" class=" add_more_surcharge plus-icon pull-right" style=";" src="{{ asset('assets/images/add_icon.png') }}"> -->
        ...
        for($room_count=0;$room_count< count($rate_allocation_details[$rate_allocation_count]['room_type']);$room_count++)
                            {
                                                                                        ...
                                                                                        <div class="col-md-2">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                    ...
                                                                                                    placeholder="Adult" id="room_adult__{{($rate_allocation_count+1)}}__{{($room_count+1)}}" name="room_adult[{{$rate_allocation_count}}][]" value="{{$rate_allocation_details[$rate_allocation_count]['room_adult'][$room_count]}}" onkeypress="javascript:return validateNumber(event)">
                                                                                            </div>
                                                                                        ...
                                                                                        <div class="col-md-2">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                    ...
                                                                                                    placeholder="CWB" id="room_cwb__{{($rate_allocation_count+1)}}__{{($room_count+1)}}" name="room_cwb[{{$rate_allocation_count}}][]"  value="{{$rate_allocation_details[$rate_allocation_count]['room_cwb'][$room_count]}}" onkeypress="javascript:return validateNumber(event)">
                                                                                            </div>
                                                                                        ...
                                                                                        <div class="col-md-2">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                    ...
                                                                                                    placeholder="CNB " id="room_cnb__{{($rate_allocation_count+1)}}__{{($room_count+1)}}" name="room_cnb[{{$rate_allocation_count}}][]" value="{{$rate_allocation_details[$rate_allocation_count]['room_cnb'][$room_count]}}"   onkeypress="javascript:return validateNumber(event)">
                                                                                            </div>
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <select
                                                                                                    ...
                                                                                                    <option value="0" >SELECT MEAL</option>
                                                                                                      ...
                                                                                                      @if(!empty($rate_allocation_details[$rate_allocation_count]['room_meal'][$room_count]) && $rate_allocation_details[$rate_allocation_count]['room_meal'][$room_count]==$meals->hotel_meals_id)
                                                ...
                                                <div class="col-sm-12 col-md-12 add_more_main_rates_allocations_div">
                                                  ...
                                                  <img  id="add_more_main_rates_allocations{{($rate_allocation_count+1)}}" class="add_more_main_rates_allocations plus-icon"   style="margin-left: auto;" src="{{ asset('assets/images/add_icon.png') }}">
                                                    @endif

                                                    @if($rate_allocation_count>0)
                                                    @if($rate_allocation_count==count($hotel_season_details)-1)
                                                    <img id="remove_more_main_rates_allocations{{($rate_allocation_count+1)}}" class="remove_more_main_rates_allocations minus-icon"   style="margin-left: auto;" src="{{ asset('assets/images/minus_icon.png') }}">
                                                     <img id="add_more_main_rates_allocations{{($rate_allocation_count+1)}}" class="add_more_main_rates_allocations plus-icon"  style="margin-left: auto;" src="{{ asset('assets/images/add_icon.png') }}">
                                                    @else
                                                    <img id="remove_more_main_rates_allocations{{($rate_allocation_count+1)}}" class="remove_more_main_rates_allocations minus-icon"   style="margin-left: auto;" src="{{ asset('assets/images/minus_icon.png') }}">
                                                     @endif
                            ...
                            @endphp
                                        ...
                                        <div class="row mt-15 mb-10">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="COST FOR ADULT " id="hotel_adult_cost{{($addon_count+1)}}" name="hotel_adult_cost[]" value="{{$addon_details[$addon_count]['hotel_adult_cost']}}" onkeypress="javascript:return validateNumber(event)">
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="COST FOR CHILD"  id="hotel_child_cost{{($addon_count+1)}}" name="hotel_child_cost[]" value="{{$addon_details[$addon_count]['hotel_child_cost']}}" onkeypress="javascript:return validateNumber(event)">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-15 mb-10">
                                        ...
                                        <div class="col-sm-12 col-md-12 add_more_addon_div">
                                                    ...
                                                    <img id="add_more_addon{{($addon_count+1)}}" class="add_more_addon plus-icon" style=";" src="{{ asset('assets/images/add_icon.png') }}"   style="margin-left: auto;">
                                                    @endif
                                                    ...
                                                    @if($addon_count==count($addon_details)-1)
                                                     ...
                                                     <img id="add_more_addon{{($addon_count+1)}}" class="add_more_addon plus-icon" style=";" src="{{ asset('assets/images/add_icon.png') }}"   style="margin-left: auto;">
                                                    @else
                                                     <img id="remove_more_addon{{($addon_count+1)}}" class="remove_more_addon minus-icon" style=";" src="{{ asset('assets/images/minus_icon.png') }}"   style="margin-left: auto;">
                                                     @endif
                                                    @endif
                                                </div>
                                            </div>
                            ...
                            @endphp
                                        ...
                                        <div class="col-sm-12 col-md-12 add_more_policies_div">
                                              @if(count($hotel_other_policies)==1)
                                                     <img id="add_more_policies{{($policy_count+1)}}" class="add_more_policies plus-icon" style=";" src="{{ asset('assets/images/add_icon.png') }}"   style="margin-left: auto;">
                                                    @endif

                                                    @if($policy_count>0)
                                                    @if($policy_count==count($hotel_other_policies)-1)
                                                    <img id="remove_more_policies{{($policy_count+1)}}" class="remove_more_policies minus-icon" style=";" src="{{ asset('assets/images/minus_icon.png') }}"   style="margin-left: auto;">
                                                     <img id="add_more_policies{{($policy_count+1)}}" class="add_more_policies plus-icon" style="" src="{{ asset('assets/images/add_icon.png') }}"   style="margin-left: auto;">
                                                    @else
                                                    <img id="remove_more_policies{{($policy_count+1)}}" class="remove_more_policies minus-icon" style="" src="{{ asset('assets/images/minus_icon.png') }}"   style="margin-left: auto;">
                                                     @endif
 ...
 $(document).on("click",".add_more_main_rates_allocations",function()
    {
        ...
        clone_rates_allocations.find(".add_more_markup_div").append('<img id="add_more_markup__'+new_id+'__1" class="add_more_markup plus-icon"   style="margin-left: auto;" src="'+add_url+'"> ');
        ...
        clone_rates_allocations.find(".add_more_surcharge_div").append('<img id="add_more_surcharge__'+new_id+'__1" class="add_more_surcharge plus-icon"   style="margin-left: auto;" src="'+add_url+'"> ');
        ...
        clone_rates_allocations.find(".add_more_rooms_allocations_div").append('<img id="add_more_rooms_allocations__'+new_id+'__1" class="add_more_rooms_allocations plus-icon"   style="margin-left: auto;" src="'+add_url+'"> ');

         $("#rates_allocations_div"+old_id).find(".add_more_main_rates_allocations_div").html("");
          if(old_id>1)
          {
           $("#rates_allocations_div"+old_id).find(".add_more_main_rates_allocations_div").append('<img id="remove_more_main_rates_allocations'+old_id+'"   style="margin-left: auto;" class="remove_more_main_rates_allocations minus-icon"  src="'+minus_url+'">');
            }
        clone_rates_allocations.find(".add_more_main_rates_allocations_div").html('');
        clone_rates_allocations.find(".add_more_main_rates_allocations_div").append(' <img id="remove_more_main_rates_allocations'+new_id+'" class="remove_more_main_rates_allocations minus-icon"   style="margin-left: auto;" src="'+minus_url+'"> <img id="add_more_main_rates_allocations'+new_id+'" class="add_more_main_rates_allocations plus-icon"   style="margin-left: auto;" src="'+add_url+'"> ');
