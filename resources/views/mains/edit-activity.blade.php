...
<script>
     $(document).on("click",".add_more_transport",function()
    {
        ...
        if(old_id>1)
        {
           $("#transport_div"+old_id).find(".add_more_transport_div").append('<img id="remove_more_transport'+old_id+'" class="remove_more_transport minus-icon" src="'+minus_url+'" style="margin-left: auto;">');
       }
