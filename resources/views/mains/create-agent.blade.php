                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">Create Agent</h4>
                                </div>
                                <div class="box-body">
                                                ...
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control select2" name="agent_country"
                                                                id="agent_country" style="width:100%">
                                    ...
                                    " style="width: 100%;" tabindex="-1" aria-hidden="true" id="agent_opr_currency"
                                                        ...
                                                        <div class="form-group">
                                                                ...
                                                                <select class="form-control" style="width: 100%;"
                                                                    ...
                                                                    <option value="guide">Guide
                                                                     ...
                                                                     <option value="sightseeing">Sightseeing
                                                                    </option>
                                                                      <option value="itinerary">Itinerary
                                                                    </option>
                                                                </select>
                                        ...
                                        <div class="row mb-10">
                                            <div class="col-md-12">
                                                <div class="box-header with-border"
                                                    ...
                                                    <button type="button" id="create_agent"
...
<h4 class="text-danger">No rights to access this page</h4>
    @endif
        ...
        <script>
            ...
            $(document).on("click", "#create_agent", function ()
                        ...
                        $.ajax({
...

                            {
...

                                {
                                    ...
                                    swal("Already Exist!",
                                        "Agent with this email or contact already exists");
