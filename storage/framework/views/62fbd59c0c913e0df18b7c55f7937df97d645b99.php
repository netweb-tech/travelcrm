  ...
  <header class="main-header">
    ...
    <a href="<?php echo e(route('agent-home')); ?>" class="logo">

      <!-- mini logo -->

	  <div class="logo-mini">
		<?php 
		$agent_logo=Session::get('travel_agent_logo');

		?>
		  <span class="light-logo"><img src="<?php echo e(asset('assets/uploads/agent_logos')); ?>/<?php echo e($agent_logo); ?>" alt="logo" style="width:60px;height:60px"></span>
    ...
    <!--   <div class="logo-lg">
		  ...
		  <span class="light-logo"><img src="<?php echo e(asset('assets/images/logo-light-text.png')); ?>" alt="logo"></span>
...
<!-- 				<ul class="menu sm-scrol">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" title="User">
              ...
              <img src="<?php echo e(asset('assets/images/user.png')); ?>" class="user-image rounded-circle" alt="User Image">
            ...
            <ul class="dropdown-menu animated flipInX">
              ...
              <li class="user-header bg-img" style="background-image: url('<?php echo e(asset('assets/images/color-plate/theme-oceansky.jpg')); ?>')" data-overlay="3">

				  <div class="flexbox align-self-center">					  

				  	<img src="<?php echo e(asset('assets/images/user.png')); ?>" class="float-left rounded-circle" alt="User Image">					  

					<h4 class="user-name align-self-center">

						<?php if(Session::has('travel_agent_id')): ?>

						<span><?php echo e(Session::get('travel_agent_fullame')); ?></span>

						<small><?php echo e(Session::get('travel_email_agent')); ?></small>
              ...
              <li class="user-body">
				    ...
				    <a class="dropdown-item" href="<?php echo e(route('agent-profile')); ?>"><i class="ion ion-person"></i> My Profile</a>
				...
				<!-- 	<a class="dropdown-item" href="javascript:void(0)"><i class="ion ion-email-unread"></i> Inbox</a>
					...
					<a class="dropdown-item" href="<?php echo e(route('agent-logout')); ?>"><i class="ion-log-out"></i> Logout</a>
  ...
  </header><?php /**PATH /home/tqfproco/crm.traveldoor.ge/resources/views/agent/includes/top-nav.blade.php ENDPATH**/ ?>